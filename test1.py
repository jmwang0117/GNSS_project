...
while True:
    ...
    if line.startswith('$GNGGA'):
            ...
            list4.append(hdop)
            list5.append(height)
            dataframe = pd.DataFrame({'Year':time1,'Time':time2,'Longitude':list1,'Latitude':list2,'number':list3,'HDOP':list4,'Altitude':list5})
            dataframe.to_csv(r"GPS.csv",index=False,sep=',')
