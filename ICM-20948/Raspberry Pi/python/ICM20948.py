...
if __name__ == '__main__':
  ...
  while True:
    ...
    add_Acc_y = []
    add_Acc_z = []
    add_Acc_x.append(round(Acc_x,3))
    add_Acc_y.append(round(Acc_y,3))
    add_Acc_z.append(round(Acc_z,3))
    add_Acc_time.append(tt)
    dataframe = pd.DataFrame({'time': add_Acc_time,'Acc_x':round(Acc_x,3),'Acc_y':round(Acc_y,3),'Acc_z':round(Acc_z,3)})
    #dataframe = pd.DataFrame({'time': add_Acc_time,'Acc_x':add_Acc_x,'Acc_y':add_Acc_y,'Acc_z':add_Acc_z})
    dataframe.to_csv("Accelerometer.csv",mode='a',header=False, sep=',',index=None)
    ...
    Mon_Accx =  str(14)+ '/'+str(34) 
    Time_All = '/' + Time_Year + '/' +Time_Month+ '/' + Time_Day+ '/' + Time_Hour+ '/' + Time_Minute+ '/' + Time_Second + '/' 
    Accx_data = str(round(Acc_x,3))  + '/' + str('Nothing')+'\r\n'
    Accx_message = Mon_Accx + Time_All + Accx_data
    print (Accx_message)
    ser1.write((Accx_message).encode('utf-8'))
    time.sleep(0.5)
    
    Mon_Accy =  str(14)+ '/'+str(35) 
    Time_All = '/' + Time_Year + '/' +Time_Month+ '/' + Time_Day+ '/' + Time_Hour+ '/' + Time_Minute+ '/' + Time_Second + '/' 
    Accy_data = str(round(Acc_y,3))  + '/' + str('Nothing')+'\r\n'
    Accy_message = Mon_Accy + Time_All + Accy_data
    print (Accy_message)
    ser1.write((Accy_message).encode('utf-8'))
    time.sleep(0.5)
    
    Mon_Accz =  str(14)+ '/'+str(36) 
    Time_All = '/' + Time_Year + '/' +Time_Month+ '/' + Time_Day+ '/' + Time_Hour+ '/' + Time_Minute+ '/' + Time_Second + '/' 
    Accz_data = str(round(Acc_x,3))  + '/' + str('Nothing')+'\r\n'
    Accz_message = Mon_Accz + Time_All + Accz_data
    print (Accz_message)
    ser1.write((Accz_message).encode('utf-8'))
    time.sleep(0.5)
